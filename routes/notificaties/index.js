...
router.post("/", async (req, res) => {
  ...
  // Trigger AO Executor voor Telegram
  try {
    await axios.post("https://sterkbouw-saas-executor.onrender.com/trigger-log", {
      type: "notificatie",
      title: titel,
      message: bericht
    })
  } catch (err) {
    console.error("Telegram trigger faalde:", err.message)
  }
